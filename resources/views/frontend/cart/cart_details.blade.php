...
{{--                                                                    <h6 class="text-black mb-0">{{$item['company_name']}}</h6>--}}
                                                                </div>
                                                                <div class="col-md-2 " style="padding: 0 !important;">
                                                                    {{$item['item_quantity']}}
                                                                </div>
                        ...
                        <div class=" d-flex">
                            ...
                            {{--                            <button class="mycart-quantity-plus w-icon-plus" button-status="plus" product-id="{{$item['item_id']}}"></button>--}}
{{--                            <button class="mycart-quantity-minus w-icon-minus" button-status="minus" product-id="{{$item['item_id']}}"></button>--}}
                        </div>
{{--                                                                    <h6 class="mb-0">{{$item['item_quantity']}}</h6>--}}
                                                                </div>
                                                                <div class="col-md-2"
