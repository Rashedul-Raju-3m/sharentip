	...
	<div class="col-lg-12">
		<div class="card no-export">
		    <div class="card-header d-sm-flex align-items-center justify-content-between">
				...
				<div>
					<a class="btn btn-primary btn-xs ajax-modal" data-title="{{ _lang('New Income') }}" href="{{ route('transactions.create') }}?type=income"><i class="ti-plus mr-1"></i>{{ _lang('New Income') }}</a>
					<a class="btn btn-danger btn-xs ajax-modal" data-title="{{ _lang('New Expense') }}" href="{{ route('transactions.create') }}?type=expense"><i class="ti-plus mr-1"></i>{{ _lang('New Expense') }}</a>
				</div>
			</div>
			<div class="card-body">
