					...
					<tbody>
						...
						<tr>	
							<td class="product-name">
								...
								@endif
								@if(isset($invoiceColumns->description->status) && $invoiceColumns->description->status != '0')
