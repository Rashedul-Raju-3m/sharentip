...
<div class="row">
	<div class="col-lg-10 offset-lg-1">
		<ul class="nav nav-tabs business-settings-tabs mb-4">
			 ...
			 <li class="nav-item"><a class="nav-link {{ isset($_GET['tab']) && $_GET['tab'] == 'quotations' ? 'active' : ''  }}" href="{{ route('customers.show', $customer->id) }}?tab=quotations"><i class="fas fa-receipt mr-2"></i><span>{{ _lang('InvQuotation') }}</span></a></li>
