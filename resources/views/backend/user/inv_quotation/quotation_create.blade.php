        ...
        $(function () {
            ...
            $('#autocomplete-ajax').autocomplete({
                ...
                onSelect: function(suggestion) {
                    ...
                    let route = $('#get_product_for_quotation').attr('data-href');
                    $.ajax({
                        url: route,
                        method: "GET",
                        dataType: "json",
