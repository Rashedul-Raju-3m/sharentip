								...
								<span class="dropdown">
								  ...
								  <form action="{{ route('transaction_categories.destroy', $category['id']) }}" method="post">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a href="{{ route('transaction_categories.edit', $category['id']) }}" data-title="{{ _lang('Update Expense Category') }}" class="dropdown-item dropdown-edit ajax-modal"><i class="ti-pencil-alt"></i>&nbsp;{{ _lang('Edit') }}</a>
