                            ...
                            <div class="card-stats-title">{{ __('Order Statistics') }} -
                                <div class="dropdown d-inline">
                                    <a class="font-weight-600 dropdown-toggle" data-toggle="dropdown"
                                        href="javascript:void(0)" id="orders-month">{{ __('All') }}</a>
                                    <ul class="dropdown-menu dropdown-menu-sm">
                                        <li class="dropdown-title">{{ __('Select Month') }}</li>
                                        @for ($i = 1; $i <= 12; $i++)
                                            <li><a href="javascript:void(0)" class="dropdown-item" onclick="getStatistics({{ $i }} )">{{ date('F', mktime(0, 0, 0, $i, 10)) }}</a></li>
                                        @endfor
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card card-hero">
                        <div class="card-header">
                            ...
                            <h4>{{ $master['users'] }}</h4>
                            <div class="card-description">{{ __('Customers') }}</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="col-lg-12">
                            {{-- <div class="card mb-4">
                                <div class="card-header pt-0 pb-0">
                                    <div class="row w-100">
                                        <div class="col-lg-8">
                                            <h2 class="section-title"> {{ __('Event Locations') }}</h2>
                                            <input type="hidden" id="events" name="events" value="{{ $events }}">
                                        </div>
                                        <div class="col-lg-4 text-right mt-2">
                                            <a href="{{ url('events') }}"><button class="btn btn-sm btn-primary ">{{ __('See all') }}</button> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header pt-0 pb-0">
                                    <div class="row w-100">
                                        <div class="col-lg-8">
                                            <h2 class="section-title"> {{ __('Recent Event') }}</h2>
                                        </div>
                                        <div class="col-lg-4 text-right mt-2">
                                                ...
                                                @foreach ($events as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span
                                                                class="tbl-info">{{ $item->people . ' allowed' }}</span>
                                                        </td>
                                                        <td>
                                                            <button class="btn-icon btn block"><i
