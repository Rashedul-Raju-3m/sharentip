...
<header class="hero-area" style="padding-top: 0px">
    <div class="container px-4">
        <div class="row gx-5 justify-content-center">
            ...
            <div class="col-md-7 d-none d-xl-block text-center wow animate__fadeInRight" data-wow-delay="1s">
                <h2>&nbsp;</h2>
                <div class="table-response">
                    <caption><b>Seats Information</b></caption>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th>Name</th>
                                <th><input type="text" name="name" placeholder="Name" class="form-control"></th>
                                <th>Mobile</th>
                                <th><input type="text" name="mobile" placeholder="Mobile" class="form-control"></th>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <th colspan="3"><input type="email" name="email" placeholder="Email" class="form-control"></th>
                            </tr>
                            <tr>
                                <th>Gender</th>
                                <th>
                                ...
                                <th>Age</th>
                                <th><input type="number" name="age" placeholder="Age" class="form-control"></th>
                            </tr>
                            <tr>
                                <th>Address</th>
                                <th colspan="3"><textarea name="address" placeholder="Address" class="form-control"></textarea></th>
                            </tr>
                            <tr>
                                <th>NID</th>
                                <th><input type="number" name="nid" placeholder="NID" class="form-control"></th>
                                <th>Nationality</th>
                                <th>
